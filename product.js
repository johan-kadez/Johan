...
function renderProduct(p,allProducts){
  ...
  const wa=`https://wa.me/${number}?text=${encodeURIComponent(`Yo B*tch, I Wanna Order ${p.productId||p.name||"produk"} With Price Like a ${rupiah(finalPrice)} Its Still Ready B*tch?`)}`;
